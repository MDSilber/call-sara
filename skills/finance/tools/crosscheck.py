...
Three checks, each computed once by the builders the reports actually use
...
liquid|spend|assets) skews the independent path by <delta> dollars so the
refusal can be proven against a scratch vault without corrupting a ledger.
"""
import os
import sys
...
from vault import amount, illiquid_currency_regex, query  # noqa: E402
from reports import liquid_balances, spend_matrix  # noqa: E402

TOLERANCE = 0.01
INJECT_ENV = "FINANCE_CROSSCHECK_INJECT"
CHECK_NAMES = ("liquid", "spend", "assets")
