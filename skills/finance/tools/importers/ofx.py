...
(skills/finance/sara/sara/cli/ofx.py); this wrapper keeps the historical
`tools/run importers/ofx.py` invocation working unchanged. Flags, output,
and behavior are identical; run the module for the full usage text.
"""
import sys
